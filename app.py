...
tape_mode = st.sidebar.toggle("Tape mode (chaotic tape)", value=False, help="Enhance constructive compression / impulse-readiness detection for uncertain, manipulated tape without changing payload contracts.", key="ui_tape_mode")
